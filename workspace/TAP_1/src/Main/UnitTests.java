...
public class UnitTests {
	...
	public void testObserver() {
		...
		System.out.println("\t[Pruebas de Observer]");
		System.out.println("No hemos sabido implementarlo");
	}
	...
	public void testRingActor(){
		...
		proxy = context.spawnActor("RingActor 0", new RingActor());
		for (int i = 1; i < 100; i++)
		{
	...
	public void testPinPongActor(){
		...
		proxy = context.spawnActor("PingPongActor 0", new PingPongActor());
		context.spawnActor("PingPongActor 1", new PingPongActor());
